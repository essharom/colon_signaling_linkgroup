...
load("../../01_Data/02_Normalized data/01_Colon/DataInfo_afterQC.RData")
...
load("../../01_Data/02_Normalized data/01_Colon/NormData_afterQC.RData")
load("../../01_Data/02_Normalized data/01_Colon/GeneExpression_afterQC.RData")
...
load("../../01_Data/02_Normalized data/01_Colon/BatchCorData_afterQC.RData")
...
grid_arrange_shared_legend(dotplot(dropGO(NormalIntermGO, level = c(1, 2, 3)),showCategory = 25),
                           dotplot(IntermCancerGO,showCategory = 25),
                           dotplot(NormalCancerGO,showCategory = 25),
                           ncol = 3,
                           nrow = 1)
...
barcode = purrr::map(fRMA, barcode)
barcode_DF =  na.omit(List2DF(barcode))
barcode_GeneDF =  na.omit(List2DF(map2(barcode, DataInfo, Probe2Symbol)))

heatmaply(barcode_GeneDF[apply(barcode_GeneDF, 1, var)!=0, ],
